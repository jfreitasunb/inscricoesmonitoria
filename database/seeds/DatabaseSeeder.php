...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $configura_monitoria = ['ano_monitoria' => '2016','semestre_monitoria' => '1', 'inicio_inscricao' => '2016-04-01', 'fim_inscricao' => '2017-07-31', 'created_at' => date("Y-m-d H:i:s"), 'updated_at' => date("Y-m-d H:i:s")];
